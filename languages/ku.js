const language = {
   ...
   msg55: `ناتوانم بەشداری کەناڵی دەنگی ئێوە بکەم. ❌`,
   msg56: `Loading playlist... ✅`,
   msg57: `<@{interaction.member.id}>، **{music_filter.length}** تراکەکانی زیادکرا بۆ نزیکی. ✅`,
   msg58: `هیچ پلەی لیستێک بەم ناوە نییە. ❌`,
   msg59: `ناوی ئەو تراکە بنووسە کە دەتەوێت لێی بگەڕێیت. ❌`,
   msg60: `هیچ ئه‌نجامێك نه‌دۆزرایه‌وه‌! ❌`,
   msg61: "Loading music(s)... 🎧",
   msg62: "لیستی ناودار زیادکرا بۆ پلەی لیستەکە. ✅",
   msg63: `نزیکی بەتاڵە. ❌`,
   msg64: "لیستی مۆسیقای سێرڤەر",
   msg65: "لە ئێستادا ژرنین دەکات",
   msg66: "داواکاری لەلایەن...",
   msg67: "لاپەرە",
   msg68: `پرۆسێسەری فەرمانەکە هەڵوەشاوەتەوە. ✅`,
   msg69: `لیستی مۆسیقای سێرڤەر - کات کۆتایی هات!`,
   msg70: `کاتەکەت بەسەرچوو بۆ بەکارهێنانی ئەم فرمانە، دەتوانیت بنووسیت \`/queue\` بۆ ئەوەی فەرمانەکە دووبارە بەکاربهێنیتەوە.`,
